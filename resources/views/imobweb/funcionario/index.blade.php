						...
						<form class="form-horizontal form-pesquisa" method="post" action="/dashboard/funcionarios/pesquisar">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									...
									@else
										<a href="/dashboard/funcionarios/cadastra-funcionario" class="btn btn-default" disabled>Novo</a>
									@endshield
								</div>
							</div>
						</form>
						...
						<table class="table table-hover"  id="funcionarios-table">
							...
							<tr>
								...
								<td>
									...
									@else
										<a href="/dashboard/funcionarios/edita-funcionario/{{$funcionario->id}}" class="btn btn-success btn-xs" disabled>
											<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
										</a>
									@endshield
									@shield('delete.funcionario')
									...
									@else
										<a href="" onclick="modalDeleta('/dashboard/funcionarios/demite-funcionario/{{$funcionario->id}}')" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal" disabled>
											<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
										</a>
									@endshield
								</td>
