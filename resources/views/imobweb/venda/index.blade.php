...
@section('content')
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            @shield('view.venda')<li  class="active"><a href="/dashboard/vendas"><svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"/></svg> Vendas</a></li>@endshield
                        ...
                        <form class="form-horizontal" method="post" action="/dashboard/vendas/pesquisar" send="">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    @else
                                        <a href="/dashboard/vendas/cadastra-venda" class="btn btn-default" disabled>Novo</a>
                                    @endshield
                                </div>
                            </div>
                        </form>
                            ...
                            @foreach($vendas as $venda)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="/dashboard/vendas/imprime-contrato/{{$venda->id}}" class="btn btn-primary btn-xs" disabled>
                                                <span class="glyphicon glyphicon-print" aria-hidden="true"></span>
                                            </a>
                                        @endshield
                                        @shield('delete.venda')
                                        ...
                                        @else
                                            <a href="" onclick="modalDeleta('/dashboard/vendas/cancela-venda/{{$venda->id}}')" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal" disabled>
                                                <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
                                            </a>
                                        @endshield
                                    </td>
